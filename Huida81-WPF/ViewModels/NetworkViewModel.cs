...
{
    public class NetworkViewModel : ViewModelBase, INavigationAware
    {
        ...
        public NetworkViewModel(IWin32InfoService win32InfoService)
        {
        ...
        public async void OnNavigatedTo(object parameter)
        {
            ...
            var data = await _win32InfoService.GetListDetailsDataAsync(Win32InfoKey.Win32_NetworkAdapter);
