...
{
    public class DisplayViewModel : ViewModelBase, INavigationAware
    {
        ...
        public DisplayViewModel(IWin32InfoService win32InfoService)
        {
        ...
        public async void OnNavigatedTo(object parameter)
        {
            ...
            var data = await _win32InfoService.GetListDetailsDataAsync(Win32InfoKey.Win32_DesktopMonitor);
