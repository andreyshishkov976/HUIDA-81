...
{
    public class KeyboardViewModel : ViewModelBase, INavigationAware
    {
        ...
        public KeyboardViewModel(IWin32InfoService win32InfoService)
        {
        ...
        public async void OnNavigatedTo(object parameter)
        {
            ...
            var data = await _win32InfoService.GetListDetailsDataAsync(Win32InfoKey.Win32_Keyboard);
